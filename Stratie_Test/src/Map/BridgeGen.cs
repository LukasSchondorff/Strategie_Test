...
public class BridgeGen : Node
{
	...
	private bool GenerateBridgeArch(List<Vector3> road_path, Vector3 first, bool bridge_shift, bool reversed, int direction){
		...
		if(direction == 0){
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(reversed)? 2 :*/ 8);//mirrored y-plane
			...
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(reversed)? 8 :*/ 2);//mirrored direction-plane
		}else if(direction == 1){
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(reversed)? 8 :*/ 2);//mirrored y-plane
			...
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(reversed)? 2 :*/ 8);//mirrored direction-plane
		}else if(direction == 2){
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(!reversed)?*/ 20 /*: 18*/);//mirrored y-plane
			...
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(!reversed)?*/ 18 /*: 20*/);//mirrored direction-plane
		}else if(direction == 3){
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(!reversed)?*/ 18 /*: 20*/);//mirrored y-plane
			...
			roadGen.SetBridgerinoItem(x, (int)first.y+ypsilon_offset, z, RoadGen.CellItem.Slope_Arch_OverKopf, /*(!reversed)?*/ 20 /*: 18*/);//mirrored direction-plane
		}

		for(int b = 0; roadGen.GetCellItem(x, (int)first.y+b, z) == -1; b++){
